...
sub1.tricontourf(x, y, rho, levels=np.linspace(rho.min(),rho.max(),20))
sub2.tricontourf(x, y, rho_u, levels=np.linspace(rho_u.min(),rho_u.max(),20))
sub3.tricontourf(x, y, rho_v, levels=np.linspace(rho_v.min(),rho_v.max(),20))
sub4.tricontourf(x, y, rho_E, levels=np.linspace(rho_E.min(),rho_E.max(),20))
plt.show()
